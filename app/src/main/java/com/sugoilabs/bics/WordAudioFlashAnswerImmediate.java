...
public class WordAudioFlashAnswerImmediate extends ActionBarActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_word_audio_flash_answer_immediate);
    ...
    private void initializeLayout() {
        ...
        answerLayout = (LinearLayout) findViewById(R.id.word_audio_immediate_flash_answer_layout);
        answerLayout.setVisibility(View.INVISIBLE);

        answerText = (EditText) findViewById(R.id.word_audio_immediate_flash_answer_texview);

        done = (Button)findViewById(R.id.word_audio_immediate_flash_answer_done);
        done.setOnClickListener(this);

        typeInButton = (Button)findViewById(R.id.word_audio_immediate_flash_answer_typein);
        typeInButton.setOnClickListener(this);

        speakOutButton = (Button)findViewById(R.id.word_audio_immediate_flash_answer_speakout);
    ...
    public void onClick(View v) {
        if(v.getId() == R.id.word_audio_immediate_flash_answer_typein){
            showAnswerTextPrompt();
        }
        if(v.getId() == R.id.word_audio_immediate_flash_answer_speakout){
            showAnswerSpeakPrompt();
        }
        if(v.getId() == R.id.word_audio_immediate_flash_answer_done){
