...
public class PictureFlashAnswerImmediate extends ActionBarActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_picture_flash_answer_immediate);
    ...
    private void initializeLayout() {
        ...
        answerLayout = (LinearLayout) findViewById(R.id.picture_flash_immediate_answer_answer_layout);
        answerLayout.setVisibility(View.INVISIBLE);

        answerText = (EditText) findViewById(R.id.picture_flash_immediate_answer_answers_texview);

        done = (Button)findViewById(R.id.picture_flash_immediate_answer_done);
        done.setOnClickListener(this);
        done.setVisibility(View.INVISIBLE);

        nextButtonLayout = (LinearLayout) findViewById(R.id.picture_flash_immediate_answer_start_done);
        nextButtonLayout.setVisibility(View.INVISIBLE);

        typeInButton = (Button)findViewById(R.id.picture_flash_immediate_answer_typein);
        typeInButton.setOnClickListener(this);

        speakOutButton = (Button)findViewById(R.id.picture_flash_immediate_answer_speakout);
    ...
    public void onClick(View v) {
        if(v.getId() == R.id.picture_flash_immediate_answer_typein){
            showAnswerTextPrompt();

        }
        if(v.getId() == R.id.picture_flash_immediate_answer_speakout){
            showAnswerSpeakPrompt();
        }
        if(v.getId() == R.id.picture_flash_immediate_answer_done){
