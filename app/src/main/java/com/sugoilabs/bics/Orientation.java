...
public class Orientation extends ActionBarActivity implements View.OnClickListener {
    ...
    private void setAllQuestionsAndAnswers() {
        questionArrayList = Arrays.asList(getResources().getStringArray(R.array.orientation_questions));
    }
    ...
    private void saveToSharedPreference(int points) {
        ...
        if(scoreSharedPreference.contains("score")){
            ...
            reportScoreSave.scoreSave.add(getResources().getString(R.string.orientation) + ":" + String.valueOf(points));
        }
    ...
    private boolean answerCorrect(int questionCount) {
        ...
        switch (questionCount){
            ...
            case 6: if(!currentAnswer.isEmpty()){
                    if(isNumeric(currentAnswer)) {
                        if (Integer.valueOf(currentAnswer) > 50 && Integer.valueOf(currentAnswer) < 80) {
                            answerStatus = true;
                        }
                    }
                }
