...
public class PrimaryColor extends ActionBarActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        ...
        if(v.getId() == R.id.primary_color_done){
            Log.d("answers",answerTextView.getText().toString());
            Log.d("timeTaken", String.valueOf(currentTimeTaken));
    ...
    private void saveToSharedPreference(int points) {
        ...
        if(scoreSharedPreference.contains("score")){
            ...
            Toast.makeText(this,"Points is: " + String.valueOf(points)+ " Total Score is:" + ScoreToast +" Time Taken: "+ String.valueOf(currentTimeTaken) ,Toast.LENGTH_LONG).show();
